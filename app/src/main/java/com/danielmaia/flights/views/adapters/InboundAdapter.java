...
public class InboundAdapter extends RecyclerView.Adapter<InboundAdapter.ViewHolder> {
    ...
    public InboundAdapter(List<Flight> flightList) {
        this.flightList = flightList;
    }

    @NonNull
    @Override
    public InboundAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull InboundAdapter.ViewHolder viewHolder, int i) {
